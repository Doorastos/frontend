...
const advantages = [
  'Дизайн для любых идей',
  'Европейские материалы',
  'Итальянская фурнитура',
  'Пожизненная гарантия от взлома',
];
  ...
  return <section className='relative flex flex-col mt-0 esm:pb-10 md:h-screen md:pb-0 md:justify-evenly'>
    ...
    <div className='flex flex-col justify-center min-h-[350px] max-esm:relative'>
      ...
      <div className='max-md:mt-[10%]'>
        ...
        <ArrowWithCircle className='text-white mt-5 md:mt-7' circleClassName='mt-2.5' circleSize={50}>Получить консультацию</ArrowWithCircle>
      </div>
    </div>
